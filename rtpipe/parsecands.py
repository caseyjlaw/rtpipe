...
def plot_interactive(mergepkl):
    ...
    snr,dm,l1,m1,time,specstd,imkur,key,sizes,colors = candfilter(0)
    ...
    snr,dm,l1,m1,time,specstd,imkur,key,sizes,colors = candfilter(thresh_default)
    ...
    snr,dm,l1,m1,time,specstd,imkur,key,sizes,colors = candfilter(-1*thresh_default)
